...
class Destination(models.Model):
    ...
    pathimages = models.CharField(max_length=255)
    ...
    destination_cost = models.CharField(max_length=255, blank=True, null=True)
    destination_duration = models.CharField(max_length=255, blank=True, null=True)
    destination_season = models.CharField(max_length=255,blank=True, null=True)
    destination_live_guide = models.CharField(max_length=255,blank=True, null=True)
    destination_max_group = models.CharField(max_length=255,blank=True, null=True)
