...
def get_numeric_price(price_str):
    # Extract numeric part from the price string, e.g., "INR 17,199 /-" -> 17199.0
    numeric_part = ''.join(filter(str.isdigit, price_str.replace(',', '')))
