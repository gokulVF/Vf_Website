...
#   path('Destination_meta/',views.Destination_meta,name='Destination_meta'),
   ...
   # flight
   path('flightadmin/', views.flightadmin, name='flightadmin'),
   ...
   #passport
   path('passportadmin/', views.passportadmin, name='passportadmin'),
   ...
   path('delete_userpanel/<int:id>/<str:type>/',views.delete_userpanel,name='delete_userpanel'),
   path('downloadattachment/<int:id>/<str:type>/',views.downloadattachment,name='downloadattachment'),
